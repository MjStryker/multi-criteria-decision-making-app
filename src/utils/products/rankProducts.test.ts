...
function getTestValues(values: [criterionData: Partial<CriterionDto>, productValues: TProductValue[]][]): {
  ...
  const productsWithCriteriaToUse = [...productCriterionValueList].map((elt, idx) => ({
    ...elt,
...
describe('rankProducts(...)', () => {
  ...
  it('test 1', () => {
    ...
    const { rankedProducts } = rankProducts(productList, criteriaToUse, productsWithCriteriaToUse);
