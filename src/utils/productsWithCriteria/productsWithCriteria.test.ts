...
describe('findProductCriterionValue(...)', () => {
  it('Return matched item', () => {
    ...
    expect(findProductWithCriterion(p3, c2, productsWithCriteria)).toStrictEqual(matchingResult);
  });
  ...
  it('Product does not exist', () => {
    ...
    expect(findProductWithCriterion(pUnmatched, c2, productsWithCriteria)).toBeNull();
  });
  ...
  it('Criterion does not exist', () => {
    ...
    expect(findProductWithCriterion(p3, cUnmatched, productsWithCriteria)).toBeNull();
  });
});
