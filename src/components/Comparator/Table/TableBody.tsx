...
const TableBody = (props: TableBodyProps) => {
  ...
  const productsSorted = props.products.sort(
    compareProductsByDefaultColumnIdxFn(SORT_BY.ASC)
  );

  const criteriasSorted = props.criterias.sort(
          ...
          <tr key={c.id}>
            ...
            >
              ...
              >
                    ...
                    <div style={{ display: "flex" }}>
                      ...
                      <input
                        ...
                        onChange={(e) => {
                          ...
                          props.updateCriteria({ ...c, name: `${newValue}` });
                        }}
                        onKeyUp={(e) => {
                          if (e.key === "Enter") {
                            props.updateCriteria({
                      ...
                      <input
                        ...
                        onChange={(e) => {
                          ...
                          props.updateCriteria({ ...c, unit: `${newValue}` });
                        }}
                        onKeyUp={(e) => {
                          if (e.key === "Enter") {
                            props.updateCriteria({
                ...
                {!isCriteriaNameCellInEditMode && (
                  <button onClick={() => props.removeCriteria(c)}>-</button>
                )}
              </div>
                  ...
                  <div style={{ display: "flex", alignItems: "center" }}>
                    ...
                    <input
                      ...
                      onChange={(e) => {
                        ...
                        props.updateCriteria({ ...c, beneficial: checked });
                      }}
                    />
                  </div>
                ) : (
              ...
              return (
                <td key={v.id} style={DATA_TABLE_STYLES.TD.CELL_VALUE}>
                  <div
                    ...
                    onBlur={() => {
                      props.setProductCriteriaValue(p, c, Number(cellValue));
                      setCellId(null);
                      setCellValue(null);
                    }}
                    style={{
                    ...
                    {isCellInEditMode ? (
                      <input
                        ...
                        onChange={(e) => {
                          ...
                          setCellValue(newValue);
                          props.setProductCriteriaValue(p, c, newValue);
                        }}
                        onKeyUp={(e) => {
                          if (e.key === "Enter") {
